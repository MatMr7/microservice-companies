...
class CategoryTest extends TestCase
{
    ...
    /**
     * Error Geting a single category that does not exists
     *
     * @return void
     */
    public function test_error_get_single_category()
    {
        $response = $this->getJson("{$this->endpoint}/fake-url");
    ...
    public function test_update_category()
    {
        ...
        $response = $this->putJson("{$this->endpoint}/{$category->url}",['title'=> '','description' => '']);
        $response->assertStatus(422);
